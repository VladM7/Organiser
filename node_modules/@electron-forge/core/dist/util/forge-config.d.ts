...
export declare type PackageJSONForInitialForgeConfig = {
    name?: string;
    config: {
        forge: {
 ...
 */
export declare function setInitialForgeConfig(packageJSON: PackageJSONForInitialForgeConfig): void;
...
declare const _default: (dir: string) => Promise<ForgeConfig>;
